...
async function assertMediaStorage() {
...
async function assertRemoteModeHasNoProjectLocalArtifacts() {
...
async function main() {
  ...
  const storage = await assertMediaStorage()
  await assertRemoteModeHasNoProjectLocalArtifacts()
