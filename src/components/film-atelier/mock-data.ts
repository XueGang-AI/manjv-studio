...
export const mockImageCompare: ImageComparePair = {
  ...
  beforeVersion: 'V1',
  afterVersion: 'V2',
  beforeModel: '豆包-Seedream-5.0',
  afterModel: '豆包-Seedream-5.0',
  beforeTime: '15 分钟前',
  afterTime: '2 分钟前',
}
...
export const mockImageOptions: ImageOption[] = [
  { id: 'opt-1', url: '', label: '版本 1', version: 'V1', modelName: '豆包-Seedream-5.0', createdAt: '5 分钟前' },
  { id: 'opt-2', url: '', label: '版本 2', version: 'V2', modelName: '豆包-Seedream-5.0', createdAt: '3 分钟前', selected: true },
  { id: 'opt-3', url: '', label: '版本 3', version: 'V3', modelName: '豆包-Seedream-5.0', createdAt: '1 分钟前' },
  { id: 'opt-4', url: '', label: '版本 4', version: 'V4', modelName: '豆包-Seedream-5.0', createdAt: '刚刚' },
]
...
export const mockModelOptions: ModelOption[] = [
  { id: 'ark-image', name: '豆包-Seedream-5.0', provider: 'ark', description: '角色/场景/分镜图生成' },
  { id: 'ark-video', name: '豆包-Seedance-2.0', provider: 'ark', description: '图生视频，最高 15s' },
]
